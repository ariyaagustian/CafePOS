...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <a class="btn btn-success mb-3" href="javascript:void(0)" id="createNewProduct"> Create New Unit</a>
            <table class="table table-bordered" id="table_units" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Unit Code</th>
                ...
                <form id="productForm" name="productForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            placeholder="Your Unit Code" value="" maxlength="50" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="unit_name" class="small">Unit Name</label>
                            <input type="text" class="form-control" id="unit_name" name="unit_name"
                            placeholder="Your Unit Name" value="" maxlength="50" required="">
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function () {
      ...
      $('body').on('click', '.deleteProduct', function () {
          ...
          if(result){
            var product_id = $(this).data("id");
            var uri = '{{ route("units.destroy", ":id") }}';
            var uri = uri.replace(':id', product_id);
